...
import 'package:eventhub/controllers/home_controller.dart';
import 'package:eventhub/controllers/user_controller.dart';
import 'package:eventhub/views/all_events_screen.dart';
import 'package:eventhub/views/contact_us.dart';
import 'package:eventhub/views/edit_profile_screen.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  final EventDetailController eventsController = Get.put(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(
            () =>
                homeController.searchResults.isEmpty
                    ? Center(
                      child: Column(
                    ...
                    : ListView.separated(
                      ...
                      itemCount:
                          homeController.searchResults.length > 4
                              ? 4
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Image.asset(ImageAssets.giftImg, width: 141.w),
            ],
          ),
        ),
      ],
