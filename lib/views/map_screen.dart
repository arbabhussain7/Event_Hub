...
import 'package:event_hub/controllers/map_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          Obx(() => controller.isLoading.value
              ...
              : FlutterMap(
                  ...
                  children: [
                    ...
                    Obx(() => controller.destination.value != null
                        ? MarkerLayer(markers: [
                            Marker(
                                height: 50.h,
                                width: 50.w,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        shape:
            RoundedRectangleBorder(borderRadius: BorderRadius.circular(33.r)),
        child: Icon(
          Icons.my_location,
          color: AppColors.whiteColor,
          size: 30.sp,
